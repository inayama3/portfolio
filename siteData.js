...
const SITE_DATA = {
  ...
  about: {
    ...
    name: "<span style='font-size: 0.8em; font-weight: 500; color: var(--text-secondary);'>代表</span><br>稲山 敬純",
    title: "映像クリエイター | 映像講師",
  ...
  contact: {
    ...
    formEndpoint: "https://script.google.com/macros/s/AKfycbxD2eezFNM9VIOZDPLHPd-0_o4qXFjP_2PN4ZS9dpcawMVFFZP2CfHHBEqwKItx2YUsrQ/exec",
    sns: [
